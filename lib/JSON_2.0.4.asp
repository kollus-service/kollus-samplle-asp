...
Notes:
    ...
    - Javascript JSON.toXML is based on the Prof. Stefan Gossner "Converting Between XML and JSON" pragmatic approach <http://www.xml.com/pub/a/2006/05/31/converting-between-xml-and-json.html>.
